...
export const GITHUB_GAME_DATA = {
  ...
  revision: "4d8608d7e3516bcae5152c75d54f7dd70e23bbb3",
  checkedAt: "2026-09-26",
  files: [
    {
      label: "Core configuration",
      path: "src/core/configuration/Config.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/4d8608d7e3516bcae5152c75d54f7dd70e23bbb3/src/core/configuration/Config.ts",
    },
    {
      label: "Doomsday Clock implementation",
      path: "src/core/game/DoomsdayClock.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/4d8608d7e3516bcae5152c75d54f7dd70e23bbb3/src/core/game/DoomsdayClock.ts",
    },
    {
      label: "Rail networks and stations",
      path: "src/core/game/RailNetworkImpl.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/4d8608d7e3516bcae5152c75d54f7dd70e23bbb3/src/core/game/RailNetworkImpl.ts",
    },
    {
      label: "Transport ships and water systems",
      path: "src/core/game/TransportShipUtils.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/4d8608d7e3516bcae5152c75d54f7dd70e23bbb3/src/core/game/TransportShipUtils.ts",
    },
    {
      label: "Unit veterancy",
      path: "src/core/game/Veterancy.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/4d8608d7e3516bcae5152c75d54f7dd70e23bbb3/src/core/game/Veterancy.ts",
    },
  ],
  sections: [
    {
