...
export const GITHUB_GAME_DATA = {
  ...
  revision: "df9114ee681dcb1a0af47215438f4e60db5d0719",
  checkedAt: "2026-09-19",
  files: [
    {
      label: "Core configuration",
      path: "src/core/configuration/Config.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/df9114ee681dcb1a0af47215438f4e60db5d0719/src/core/configuration/Config.ts",
    },
    {
      label: "Doomsday Clock implementation",
      path: "src/core/game/DoomsdayClock.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/df9114ee681dcb1a0af47215438f4e60db5d0719/src/core/game/DoomsdayClock.ts",
    },
    {
      label: "Rail networks and stations",
      path: "src/core/game/RailNetworkImpl.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/df9114ee681dcb1a0af47215438f4e60db5d0719/src/core/game/RailNetworkImpl.ts",
    },
    {
      label: "Transport ships and water systems",
      path: "src/core/game/TransportShipUtils.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/df9114ee681dcb1a0af47215438f4e60db5d0719/src/core/game/TransportShipUtils.ts",
    },
    {
      label: "Unit veterancy",
      path: "src/core/game/Veterancy.ts",
      url: "https://github.com/openfrontio/OpenFrontIO/blob/df9114ee681dcb1a0af47215438f4e60db5d0719/src/core/game/Veterancy.ts",
    },
  ],
  sections: [
    {
